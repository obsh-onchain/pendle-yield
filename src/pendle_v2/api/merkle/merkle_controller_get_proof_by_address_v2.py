...
def sync_detailed(
    ...
    *,
    ...
    """Get merkle proof of a user by address

     Return merkle proof of the given user for all supported chains, support all campaigns.

    The complete merkle file can be found in our [Merkle distribution
    repository](https://github.com/pendle-finance/merkle-distributions)
