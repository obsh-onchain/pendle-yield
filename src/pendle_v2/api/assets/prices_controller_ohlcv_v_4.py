...
def sync_detailed(
    ...
    *,
    ...
    """Get PT / YT / LP historical price by address

     Historical price data for PT / YT tokens / LP tokens. We do not support historical price for **SY
    and non-Pendle tokens**.
